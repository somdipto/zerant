# Security Blocklist Refresh — Universal Session Prompt
...
This session is for the Security Blocklist Refresh implementation track.

Before coding:
1. git pull origin main
2. Read AGENTS.md
3. Read docs/implementations/security-blocklist-refresh/LEES-MIJ-EERST.md fully
...
- update docs/implementations/security-blocklist-refresh/LEES-MIJ-EERST.md with:
  - phase status
  - date
